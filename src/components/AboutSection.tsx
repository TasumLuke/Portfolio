      ...
      <div className="container mx-auto px-4 md:px-6">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
          <AnimatedSection direction="left" className="order-2 lg:order-1">
            ...
            My academic interests are cross-disciplinary and include biomimetics, synthetic biology, neuroscience, public health, and genetics, specifically CRISPR technology. Apart from the academic life, I also co-founded the Northeast Center for High School Research (NECHR) as a non-profit organization to spread research among the high school students across the globe at no cost- for those who might not have the opportunity otherwise. I am also the founder of the Tani Language Foundation for spreading and conserving the Tani, which is spoken by my native people. My project, Ngok Siang, for rescuing the dolphins of Siang River, became a runner-up in the 9th Millennium Oceans Prize organized by the Millennium Campus Network (MCN).
            </p>
            <p className="text-muted-foreground mb-8 leading-relaxed">
