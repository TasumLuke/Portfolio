      ...
      <div className="container mx-auto px-4 md:px-6">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
          <AnimatedSection direction="left" className="order-2 lg:order-1">
            ...
            <strong>Hello! </strong> I am Luke Rimmo Loyi Lego, a pre-med student and biomedical engineering major at Stevens Institute of Technology in New Jersey. I am honored to have been recognized as an NTSE Scholar, one of India's most prestigious academic awards.
            </p>
